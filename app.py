...
def get_inference(token):
    ...
    headers = {
        ...
        "x-cg-demo-api-key": "CG-RwJyn3wfHPXfkawubijyMWka" # replace with your API key
    }
    ...
    try:
        forecast = pipeline.predict(context, prediction_length, top_p=0.1, temperature=0.01)  # shape [num_series, num_samples, prediction_length]
